            ...
            <div class="w-64 bg-blue-50 shadow-md h-screen sticky top-0">
                ...
                <nav class="mt-2 overflow-y-auto flex-1 flex flex-col" style="height: calc(100vh - 100px);">
                    <div class="flex-1 overflow-y-auto">
                        <a href="{{ route('dashboard') }}" class="flex items-center px-6 py-3 text-gray-700 hover:bg-blue-100 hover:text-blue-800">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                            Dashboard
                        </a>
                        <a href="{{route('ViewCustomer')}}" class="flex items-center px-6 py-3 text-gray-700 hover:bg-blue-100 hover:text-blue-800">
                        ...
                        <a href="{{ route('ViewSupplier')}}" class="flex items-center px-6 py-3 text-gray-700 hover:bg-blue-100 hover:text-blue-800">
                        ...
                        <div class="py-3 px-6 border-t border-gray-200">
                            ...
                            <a href="#" class="flex items-center px-6 py-2 text-gray-700 hover:bg-blue-100 hover:text-blue-800 text-sm">
                                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                                Add Product
                            </a>
                            <a href="#" class="flex items-center px-6 py-2 text-gray-700 hover:bg-blue-100 hover:text-blue-800 text-sm">
                        ...
                        <div class="py-3 px-6 border-t border-gray-200">
                            ...
                            <a href="#" class="flex items-center px-6 py-2 text-gray-700 hover:bg-blue-100 hover:text-blue-800 text-sm">
                                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
