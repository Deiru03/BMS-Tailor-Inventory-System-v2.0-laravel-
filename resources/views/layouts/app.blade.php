    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 flex">
            ...
            <div class="w-64 bg-blue-50 shadow-md h-screen sticky top-0">
                ...
                <nav class="mt-2 overflow-y-auto" style="max-height: calc(100vh - 100px);">
                    ...
                    <a href="#" class="flex items-center px-6 py-3 text-gray-700 hover:bg-blue-100 hover:text-blue-800">
