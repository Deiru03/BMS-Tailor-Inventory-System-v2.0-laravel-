<x-app-layout>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    ...
                                                    @if($sale->payment_status === 'partial')
                                                        <button onclick="openPaymentModal('{{ $sale->id }}', '{{ $sale->balance }}')" 
                                                                class="text-green-600 hover:text-green-900" title="Pay Remaining Balance">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Enter the amount to pay for the remaining balance.
                                </p>
    ...
    <script>
        ...
        function openPaymentModal(saleId, balance) {
            ...
            form.action = `/sales/${saleId}/pay`;
            amountInput.max = balance; // Set the max amount to the remaining balance
